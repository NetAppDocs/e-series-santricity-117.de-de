...
[role="lead"]
Wenn ein Laufwerk ausfällt oder aus einem anderen Grund ersetzt werden soll, können Sie das ausgefallene Laufwerk logisch durch ein nicht zugewiesenes Laufwerk oder ein vollständig integriertes Hot Spare ersetzen.
