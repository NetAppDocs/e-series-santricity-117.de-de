...
[NOTE]
====
Sie können diesen Status auch anzeigen, indem Sie auf das SFP-Symbol klicken image:../media/sam1130-ss-hardware-sfp-icon.gif[""], Neben der Dropdown-Liste Regal.
