...
** Die reservierte Kapazität kann jedoch je nach Anzahl der Änderungen an den ursprünglichen Daten variieren.
Je länger ein Storage-Objekt aktiv ist, desto größer sollte die reservierte Kapazität sein.
